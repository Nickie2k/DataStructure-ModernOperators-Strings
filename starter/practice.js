...
// Target the first and second data properties within the books array

//* Destructure the books array into a variable called thirdBook. You must skip the first two books?

const [, , thirdBook] = books;

//* Below is the nested ratings array that contains two other arrays. Destructure the nested ratings arrays into two variables called rating and ratingsCount. In the result of your destructuring, the ratings variable should store a number 4.19, and the ratingsCount variable should store a number 14458?
...
console.log(fiveStarRatings, oneStarRatings);
